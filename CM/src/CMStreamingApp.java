...
public class CMStreamingApp {
    ...
    public static void main(String argv[]) throws Exception {
        ...
        int RTSP_server_port = Integer.parseInt("61234");
        
        //String ServerHost = argv[0];
        String ServerHost = "114.70.21.78";
        //String ServerHost = "114.70.21.126";
        //String ServerHost = "172.16.29.203";
        ...
        System.out.println(" RTSPBufferedWriter : "+RTSPBufferedWriter);
